...
- [ ] Verifier v2 emits strict JSON, does not rewrite answers, validates literal/source traceability, uses `0.55`/`0.75`, and documents a-1 APROBADO, a-2 RECHAZADO, a-3 RECHAZADO because its nonliteral paraphrase fails the strict citation check, a-4 RECHAZADO, and a-5 DUDOSO with reasons.
